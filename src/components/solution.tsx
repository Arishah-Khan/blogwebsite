...
export default function Solution() {
    return (
        <main className="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-4 pb-16 md:pb-8 lg:pb-4">
            <div className="px-3 sm:px-8 py-10 md:px-6 md:py-8 lg:px-12 lg:py-16 flex flex-col justify-center items-center md:items-start">
                ...
                <div>
                    <h6 className="text-[#94d533] font-semibold text-sm md:text-base lg:text-lg mb-4 text-start flex items-center gap-2">
                    ...
                    <p className="text-[#cbcbce] text-xs md:text-sm lg:text-base mb-4 text-start">
                    ...
                    <h6 className="text-[#94d533] font-semibold text-sm md:text-base lg:text-lg mb-4 text-start flex items-center gap-2">
                       <span className="p-2 bg-[#94d533] flex justify-center items-center rounded-[50%]">
                    ...
                    <h6 className="text-[#94d533] font-semibold text-sm md:text-base lg:text-lg mb-4 text-start flex items-center gap-2">
                       <span className="p-2 bg-[#94d533] flex justify-center items-center rounded-[50%]"><Image src="/images/work-iocn3.png" alt="check" width={20} height={20} /></span>
                        Secure Data Solutions
                    </h6>
                    <p className="text-[#cbcbce] text-xs md:text-sm lg:text-base text-start">
            ...
            <div className="flex flex-wrap justify-center items-center gap-6">
                <div className="grid grid-rows-1 justify-center items-center gap-6">
                    <div><Image src="/images/solution1.png" alt="technology" width="200" height="200" /></div>
                    <div><Image src="/images/solution2.png" alt="technology" width="200" height="200" /></div>
                </div>
                <div>
                <div><Image src="/images/solution3.png" alt="technology" width="200" height="200" /></div>
                </div>
            </div>
        </main>
    )

...
export default function Button({ text, bgColour, textColour, onClick }: ButtonProps) {
  return (
    <button
      ...
      className="flex items-center justify-center gap-2 px-3 py-2 md:px-6 rounded-[50px] font-bold md:font-extrabold text-base md:text-lg transition-all duration-300 hover:scale-105"
    >
